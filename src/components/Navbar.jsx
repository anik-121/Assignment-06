...
const Navbar = ({ cartCount }) => {
    return (
        <div className="navbar bg-base-100 shadow-sm px-4 md:px-10 lg:px-18 sticky top-0 z-50">
            ...
            <div className="navbar-end gap-2 md:gap-4 lg:gap-6">
                ...
                <span className="cursor-pointer hover:text-[#4f39f6] transition-colors hidden sm:block">Login</span>
                <a className="btn bg-gradient-to-r from-[#4f39f6] to-[#9514fa] text-white rounded-full border-none px-4 md:px-6 text-sm">
                    Get Started
                </a>
            </div>
        </div>
